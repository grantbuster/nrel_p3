...
from nrel_p3.version import __version__ as v
...
latex_documents = [
    (master_doc, 'nrel_p3.tex', 'NREL p3 Documentation',
     'Grant Buster', 'manual'),
]
...
man_pages = [
    (master_doc, 'nrel_p3', 'NREL p3 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'nrel_p3', 'NREL p3 Documentation',
     author, 'nrel_p3', 'One line description of project.',
     'Miscellaneous'),
]
